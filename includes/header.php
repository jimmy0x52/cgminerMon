        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages" id="marketData">
                    	<?
						...
						?>
                        	<li>
                    			<a href="#">
                                    ...
                                    <?if($marketInfo['primarycode'] == 'DOGE'){?><div>My Doge: <?echo round($marketInfo['recenttrades'][0]['price'] * $myDoge,2);?>&nbsp;<?echo $marketInfo['secondarycode'];?></div><?}?>
                           	 	</a>
                        	</li>
						<?
						}
